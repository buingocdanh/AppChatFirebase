...
import com.koddev.chatapp.Fragments.Friends;
import com.koddev.chatapp.Fragments.RequestsFragment;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case  R.id.main_all_btn:
               // FirebaseAuth.getInstance().signOut();
                // change this code beacuse your app will crash
                startActivity(new Intent(MainActivity.this, UserActivity.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                return true;
        }
